...
export default function Header() {
 ...
 <Link to="/" className="text-2xl font-bold text-orange-500 focus:outline-none">
        ...
        <nav className="flex items-center gap-6">
           <Link to="/" className="text-textPrimary hover:text-secondary transition-colors">
                       Home
                     </Link>
                     
                     
                     <Link to="/benefits" className="text-textPrimary hover:text-secondary transition-colors">
                       Benefits
                     </Link>
